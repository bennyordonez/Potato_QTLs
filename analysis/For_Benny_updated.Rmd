...
plot(scanone.imp.LG.Benny.M[,c(1,2,14)], bandcol="gray90")
abline(h=perm95.LG.Benny.M[1,1],lty=2:6)

scanone.imp.LG.Benny.P <- scanone(LG.Benny.P, pheno.col=1:12, method="imp")
plot(scanone.imp.LG.Benny.P[,c(1,2,14)], bandcol="gray90")
...
#cim
cim.LG.Benny.M <- cim(LG.Benny.M,n.marcovar=3, method="imp")
cim.LG.Benny.P <- cim(LG.Benny.P,n.marcovar=3, method="imp")

#summary
summary(cim.LG.Benny.M)
summary(cim.LG.Benny.P)

#check the maximun LOD score
max(cim.LG.Benny.M)
max(cim.LG.Benny.P) #on Nov30, chr8 LOD 3.08, see graph#

plot(cim.LG.Benny.P, bandcol="gray90", col="blue",lty=2,lwd=2)
